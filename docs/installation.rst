...
This is the preferred method to install ZEPPELIN, as it will always install the most recent stable release.
...
The sources for ZEPPELIN can be downloaded from the `Github repo`_.
